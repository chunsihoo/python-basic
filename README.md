...
### 📌 문제 설명
정수 1개를 입력받아 그 수의 부호를 반대로 바꾸어 출력하시오.
...
### 📌 문제 설명
문자 1개를 입력받아 ASCII 기준으로 다음 문자를 출력하시오.
...
### 📌 문제 설명
단어 1개와 정수 1개를 입력받아 해당 단어를 입력받은 횟수만큼 반복 출력하시오.
...
### 📌 문제 설명
실수 2개를 입력받아 첫 번째 수를 두 번째 수만큼 거듭제곱하여 출력하시오.
...
## ✅ Question 06. 실수 1개 입력받아 소수점 이하 둘째 자리까지 출력하기

### 📌 문제 설명
실수 1개를 입력받아 소수점 이하 둘째 자리까지 출력하시오.
...
### 📌 문제 설명
정수 1개를 입력받아 해당 값이 True 또는 False인지 출력하시오.
...
### 📌 문제 설명
정수 2개를 입력받아 둘 다 0이 아닐 때만 True를 출력하시오.
...
### 📌 문제 설명
정수 2개를 입력받아 하나라도 0이 아니면 True를 출력하시오.
...
### 📌 문제 설명
정수 2개를 입력받아 두 값의 참/거짓이 서로 다를 때만 True를 출력하시오.
...
### 📌 문제 설명
정수 2개를 입력받아 두 값의 참/거짓이 서로 같을 때만 True를 출력하시오.
...
### 📌 문제 설명
정수 2개를 입력받아 둘 다 0일 때만 True를 출력하시오.
...
## ✅ Question 15. 여러 정수 중 짝수만 출력하기

### 📌 문제 설명
여러 개의 정수를 입력받아 그 중 짝수만 출력하시오.
...
### 📌 문제 설명
정수 3개를 입력받아 각 숫자가 짝수이면 "even", 홀수이면 "odd"를 출력하시오.
...
입력 처리, 형변환, 산술 연산, 논리 연산, 조건문, 반복문의 기본 구조를 이해하는 데 목적이 있다.
...
파이썬의 **기본 입출력 방식과 출력 함수 `print()`의 동작 원리**를 이해하고  
변수 출력, 구분자(`sep`), 출력 종료 문자(`end`) 등을 활용하여  
출력 형식을 자유롭게 제어하는 방법을 학습하는 것을 목표로 합니다.

이를 통해 프로그램의 실행 결과를 **정확하게 표현하고**  
기초적인 **데이터 출력 로직을 구현할 수 있는 기반을 다집니다.**
...
### 📌 개념 설명
`print()` 함수는 **괄호 안의 값을 화면에 출력하는 함수입니다.**
...
변수에 값을 저장한 후 `print()` 함수로 출력할 수 있습니다.
...
➡ 변수에 저장된 값을 이용하여 **연산 후 출력도 가능합니다.**
...
`print()` 함수는 기본적으로 **출력 후 줄바꿈(Enter)** 을 수행합니다.
...
➡ `print()`를 여러 번 사용하면 자동으로 **다음 줄에 출력됩니다.**
...
출력할 값이 여러 개일 경우 **콤마( , )로 구분하여 출력할 수 있습니다.**
...
➡ 여러 값을 출력하면 **자동으로 공백(space)** 이 삽입됩니다.
...
## 📌 개념 설명
`sep` 옵션을 사용하면 **출력 값 사이의 구분자**를 변경할 수 있습니다.
...
## 📌 개념 설명
`end` 옵션을 사용하면 **출력 후 줄바꿈 대신 다른 문자**를 출력할 수 있습니다.
...
- `end` : **출력 마지막에 붙는 문자 설정**
- 기본값 : `\n` (줄바꿈)

---
# ✨ 마무리

파이썬에서 `print()` 함수는 프로그램의 실행 결과를  
**화면에 출력하는 가장 기본적인 도구**입니다.

---

## 📌 특히 다음 기능들을 이해하는 것이 중요합니다
...
이러한 기능을 활용하면 **프로그램의 출력 형식을 상황에 맞게 자유롭게 제어**할 수 있습니다.
...
과 같은 내용에서도 **정확한 결과를 표현하는 데 중요한 역할**을 합니다.
...
파이썬의 `input()`과 `print()` 함수를 활용하여  
사용자 입력 처리와 출력 방식을 이해하는 것을 목표로 합니다.
...
사용자와 상호작용하며 프로그램 실행에 필요한 값을 입력받기 위해  
`input()` 함수를 사용합니다.
...
입력받은 문자열을 숫자로 사용하려면 `int()` 함수로 변환해야 합니다.
...
`print()` 함수는 프로그램의 실행 결과를 출력하는 가장 기본적인 도구입니다.

다음 기능을 이해하는 것이 중요합니다.
...
이러한 기능을 활용하면 출력 형식을 자유롭게 제어할 수 있으며,  
조건문, 반복문, 알고리즘 구현에서도 중요한 역할을 합니다.
